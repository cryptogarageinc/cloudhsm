...
//go:generate go run go.uber.org/mock/mockgen@v0.2.0 -source pkcs11.go -destination mock/pkcs11.go -package mock
//go:generate go run golang.org/x/tools/cmd/goimports@v0.12.0 -w mock/pkcs11.go
